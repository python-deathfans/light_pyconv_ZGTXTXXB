...
from keras.layers import Dense, Dropout, Activation, Flatten, Lambda, DepthwiseConv2D, SeparableConv2D, GlobalAveragePooling2D, Multiply
...
class cifar10resnet18:
    ...
    def get_callback_list():
        ...
        callback_list = [
            ...
            TensorBoard('./logs/cifar10_attention')
            # WandbCallback()
        ]
    ...
    def py_block(self, inputs, in_filters, out_filters):
        ...
        a = Dense(in_filters/4, activation='relu')(a)
        a = Dense(in_filters, activation='sigmoid')(a)
        x = Multiply()([x, a])
