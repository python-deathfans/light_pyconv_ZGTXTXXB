...
from keras.layers import Conv2D, MaxPooling2D, BatchNormalization, SeparableConv2D, DepthwiseConv2D, SpatialDropout2D, Multiply
...
class cifar10vgg:
    ...
    def get_callback_list():
        ...
        callback_list = [
            ...
            TensorBoard("./logs/cifar100_attention")
            # WandbCallback()
        ]
