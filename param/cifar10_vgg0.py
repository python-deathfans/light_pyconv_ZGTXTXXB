...
class cifar10vgg:
    ...
    def gp_5x5(self, inputs, pre_layer):
        ...
        # 第一路
        tower_1 = Conv2D(interval/4, (5, 5), padding='same',
                         input_shape=self.x_shape,kernel_regularizer=regularizers.l2(self.weight_decay),
                         activation='relu', name=f'5x5_{i}')(normalized1_1)

        i += 1

        # 第二路
        tower_2 = Conv2D(interval/4, (5, 5), padding='same',
                         input_shape=self.x_shape,kernel_regularizer=regularizers.l2(self.weight_decay),
                         activation='relu')(normalized1_2)

        # 第三路
        tower_3 = Conv2D(interval/4, (5, 5), padding='same',
                         input_shape=self.x_shape,kernel_regularizer=regularizers.l2(self.weight_decay),
                         activation='relu')(normalized1_3)

        # 第四路
        tower_4 = Conv2D(interval/4, (5, 5), padding='same',
                         input_shape=self.x_shape,kernel_regularizer=regularizers.l2(self.weight_decay),
